...
int noOfHands()
{
    string cards[] = {"8C","TS","KC","9H","4S","7D","2S","5D","3S","AC",
...
"AS","KD","3D","JD","8H","7C","8C","5C","QD","6C"
    ...
    vector<string> cardV(cards,cards+10000);

    vector<string> player1(5,"");
    vector<string> player2(5,"");
    vector<int> cards1(15,0);
    vector<int> cards2(15,0);

    int hands=0,inner=0,count=0,count2=0,loop=0,temp=0;
    bool strFlag1=false,flFlag1=false,t2Flag1=false,t22Flag1=false,t3Flag1=false,t32Flag1=false,t4Flag1=false,royalFlag1=false;
    bool strFlag2=false,flFlag2=false,t2Flag2=false,t22Flag2=false,t3Flag2=false,t32Flag2=false,t4Flag2=false,royalFlag2=false;
    for(hands=0;hands<1000;hands++)
    {
        player1.clear();
        copy(cardV.begin()+(10*hands),cardV.begin()+(10*hands)+5,back_inserter(player1));
        
        player2.clear();
        copy(cardV.begin()+(10*hands)+5,cardV.begin()+(10*hands)+10,back_inserter(player2));
        
        fill(cards1.begin(),cards1.end(),0);
        fill(cards2.begin(),cards2.end(),0);
        
        for(inner=0;inner<5;inner++)
        {
            if(player1[inner][0]=='2' || player1[inner][0]=='3' || player1[inner][0]=='4' || player1[inner][0]=='5' || player1[inner][0]=='6' || player1[inner][0]=='7' || player1[inner][0]=='8' || player1[inner][0]=='9')
            {
                cards1[(int)(player1[inner][0]-48)]++;
            }
            
            else if(player1[inner][0]=='T')
            {
                cards1[10]++;
            }
            
            else if(player1[inner][0]=='J')
            {
                cards1[11]++;
            }
            
            else if(player1[inner][0]=='Q')
            {
                cards1[12]++;
            }
            
            else if(player1[inner][0]=='K')
            {
                cards1[13]++;
            }
            
            else if(player1[inner][0]=='A')
            {
                cards1[14]++;
            }
            
            if(player2[inner][0]=='2' || player2[inner][0]=='3' || player2[inner][0]=='4' || player2[inner][0]=='5' || player2[inner][0]=='6' || player2[inner][0]=='7' || player2[inner][0]=='8' || player2[inner][0]=='9')
            {
                cards2[(int)(player2[inner][0]-48)]++;
            }
            
            else if(player2[inner][0]=='T')
            {
                cards2[10]++;
            }
            
            else if(player2[inner][0]=='J')
            {
                cards2[11]++;
            }
            
            else if(player2[inner][0]=='Q')
            {
                cards2[12]++;
            }
            
            else if(player2[inner][0]=='K')
            {
                cards2[13]++;
            }
            
            else if(player2[inner][0]=='A')
            {
                cards2[14]++;
            }
        }
        ...
        */
        ...
        if(player1[0][1]==player1[1][1]==player1[2][1]==player1[3][1]==player1[4][1])
        {
            flFlag1=true;
        }
        
        if(player2[0][1]==player2[1][1]==player2[2][1]==player2[3][1]==player2[4][1])
        {
            flFlag2=true;
        }
        temp=0;
        ...
        if(cards1[inner]==1 && cards1[inner+1]==1 && cards1[inner+2]==1 && cards1[inner+3]==1 && cards1[inner+4]==1)
        {
            if(inner==10)
            {
                royalFlag1=true;
        ...
        if(cards2[inner]==1 && cards2[inner+1]==1 && cards2[inner+2]==1 && cards2[inner+3]==1 && cards2[inner+4]==1)
        {
            if(inner==10)
            {
                royalFlag2=true;
        ...
        //royal flush start
        if(royalFlag1 && !royalFlag2)
        {
            count++;
			cout << "Winner is 1" << endl;
            continue;
        }
        else if(!royalFlag1 && royalFlag2)
        {
            count2++;
			cout << "Winner is 2" << endl;
            continue;
        }
        //royal flush end
        
        //straight flush start
        if((flFlag1 && strFlag1) && !(flFlag2 && strFlag2))
        {
            count++;
			cout << "Winner is 1" << endl;
            continue;
        }
        else if(!(flFlag1 && strFlag1) && (flFlag2 && strFlag2))
        {
            count2++;
			cout << "Winner is 2" << endl;
            continue;
		...
		int temp31=0,temp21=0,temp32=0,temp22=0;
		//Full House start
		for(inner=2;inner<15;inner++)
		{
			if(cards1[inner]==1)
		...
		if(t32Flag1 && !t32Flag2)
        {
            count++;
			cout << "Winner is 1" << endl;
            continue;
        }
        else if(!t32Flag1 && t32Flag2)
        {
            count2++;
			cout << "Winner is 2" << endl;
            continue;
		...
		for(loop=2;loop<15;loop++)
		{
			if(cards1[loop]==2)
			{
				...
				if(loop<14)
				{
					for(inner=loop+1;inner<15;inner++)
					{
						if(cards1[inner]==2)
						{
							t22Flag1=true;
		...
		//Two pairs start
		if(t22Flag1 && !t22Flag2)
        {
            count++;
			cout << "Winner is 1" << endl;
            continue;
        }
        else if(!t22Flag1 && t22Flag2)
        {
            count2++;
			cout << "Winner is 2" << endl;
            continue;
		...
		for(loop=14;loop>1;loop--)
		{
			if(cards1[loop]>0 && cards2[loop]==0)
			{
				count++;
				cout << "Winner is 1" << endl;
				break;
        ...
        cout << "flags" << endl;
        cout  << "strFlag1=" << strFlag1 << endl;
        
        cout  << "flFlag1=" << flFlag1 << endl;
        
        cout  << "t2Flag1=" << t2Flag1 << endl;
        
        cout  << "t22Flag1=" << t22Flag1 << endl;
        
        cout  << "t3Flag1=" << t3Flag1 << endl;
                
        cout  << "t32Flag1=" << t32Flag1 << endl;        
        
        cout  << "t4Flag1=" << t4Flag1 << endl;
        
        cout  << "royalFlag1=" << royalFlag1 << endl;
        
        cout  << "strFlag2=" << strFlag2 << endl;
        
        cout  << "flFlag2=" << flFlag1 << endl;
        
        cout  << "t2Flag2=" << t2Flag1 << endl;
        
        cout  << "t22Flag2=" << t22Flag1 << endl;
        
        cout  << "t3Flag2=" << t3Flag1 << endl;
                
        cout  << "t32Flag2=" << t32Flag1 << endl;        
        
        cout  << "t4Flag2=" << t4Flag1 << endl;
        
        cout  << "royalFlag2=" << royalFlag1 << endl;*/
        //debug code end
    }    
cout << count2 << endl;
return count;
